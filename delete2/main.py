...
class MainWindow(object):
    ...
    def __init__(self, width, height):
        ...
        # 动画设置界面
        self.animation = Frame(self.noteBook)
        ...
        # 动画设置界面处理对象
        self.animInfo =Animation(self.animation, self.projectInfoConfig, self.log)
        ...
        self.noteBook.add(self.animation, text="动画")
    ...
    def layoutWindow(self):
        ...
        self.animInfo.layout(width, height)
